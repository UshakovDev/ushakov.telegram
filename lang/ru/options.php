...
$MESS["USH_TG_SECTION_EVENTS"] = "<b>Какие события отправлять</b>";
...
$MESS["USH_TG_HINT_CHAT_IDS"] = "Можно указывать несколько chat_id через запятую, поддерживаются отрицательные ID супергрупп и @channelname.";
